...
BEGIN
	...
	VALUES (/*specialPatientProgramTemplateId*/'a7b65d0f-5b87-4050-a5ef-ef79ef0ec753', '{ "Identifier": { "GUID": "a7b65d0f-5b87-4050-a5ef-ef79ef0ec753", "FriendlyName": "Special Patient Program" }, "AuthorizedUsers": [ { "User": "Craig.Robinson@devtestns.onmicrosoft.com" }, { "User": "Inica.Yang@devtestns.onmicrosoft.com" }, { "User": "Kevin.Armstrong@devtestns.onmicrosoft.com" } ], "AdminNotifyEmailAddresses": [ { "EmailAddress": "Craig.Robinson@novascotia.ca" }, { "EmailAddress": "Inica.Yang@novascotia.ca" }, { "EmailAddress": "Kevin.Armstrong@novascotia.ca" }, { "EmailAddress": "amy.macdonald@novascotia.ca" } ] }');
	...
	INSERT INTO public."Form_Template"(	"Id", "Data")
	VALUES (/*earlyChildhoodDevelopmentServiceTemplateId*/'170e324d-7aa9-4faf-8b42-5a7f6363fda5', '{ "Identifier": { "GUID": "170e324d-7aa9-4faf-8b42-5a7f6363fda5", "FriendlyName": "Early Childhood Development Service" }, "AuthorizedUsers": [ { "User": "Craig.Robinson@devtestns.onmicrosoft.com" }, { "User": "Inica.Yang@devtestns.onmicrosoft.com" }, { "User": "Kevin.Armstrong@devtestns.onmicrosoft.com" } ], "AdminNotifyEmailAddresses": [ { "EmailAddress": "Craig.Robinson@novascotia.ca" }, { "EmailAddress": "Inica.Yang@novascotia.ca" }, { "EmailAddress": "Kevin.Armstrong@novascotia.ca" }, { "EmailAddress": "amy.macdonald@novascotia.ca" } ] }');
	INSERT INTO public."Form_Submission"("Id", "Template_Id", "Data")
	...
	INSERT INTO public."Form_Template"(	"Id", "Data")
	VALUES (/*drugInformationSystemTemplateId*/'17fcd5c7-84cf-4cdc-bb2f-5649396ae8c6', '{ "Identifier": { "GUID": "17fcd5c7-84cf-4cdc-bb2f-5649396ae8c6", "FriendlyName": "Drug Information System" }, "AuthorizedUsers": [ { "User": "Craig.Robinson@devtestns.onmicrosoft.com" }, { "User": "Inica.Yang@devtestns.onmicrosoft.com" }, { "User": "Kevin.Armstrong@devtestns.onmicrosoft.com" } ], "AdminNotifyEmailAddresses": [ { "EmailAddress": "Craig.Robinson@novascotia.ca" }, { "EmailAddress": "Inica.Yang@novascotia.ca" }, { "EmailAddress": "Kevin.Armstrong@novascotia.ca" }, { "EmailAddress": "amy.macdonald@novascotia.ca" } ] }');
	INSERT INTO public."Form_Submission"("Id", "Template_Id", "Data")
	...
	INSERT INTO public."Form_Template"(	"Id", "Data")
	VALUES (/*childCareSubsidyReviewTemplateId*/'0d9fe6dc-a167-4fe1-9de4-dac996a44ac8', '{ "Identifier": { "GUID": "0d9fe6dc-a167-4fe1-9de4-dac996a44ac8", "FriendlyName": "Child Care Subsidy Review"  }, "AuthorizedUsers": [ { "User": "Craig.Robinson@devtestns.onmicrosoft.com" }, { "User": "Inica.Yang@devtestns.onmicrosoft.com" }, { "User": "Kevin.Armstrong@devtestns.onmicrosoft.com" } ], "AdminNotifyEmailAddresses": [ { "EmailAddress": "Craig.Robinson@novascotia.ca" }, { "EmailAddress": "Inica.Yang@novascotia.ca" }, { "EmailAddress": "Kevin.Armstrong@novascotia.ca" }, { "EmailAddress": "amy.macdonald@novascotia.ca" } ] }');
	INSERT INTO public."Form_Submission"("Id", "Template_Id", "Data")
	...
	INSERT INTO public."Form_Template"(	"Id", "Data")
	VALUES (/*childCareSubsidyTemplateId*/'a84c16c0-5ea6-4cc0-87ae-2fdd575715e0', '{ "Identifier": { "GUID": "a84c16c0-5ea6-4cc0-87ae-2fdd575715e0", "FriendlyName": "Child Care Subsidy"  }, "AuthorizedUsers": [ { "User": "Craig.Robinson@devtestns.onmicrosoft.com" }, { "User": "Inica.Yang@devtestns.onmicrosoft.com" }, { "User": "Kevin.Armstrong@devtestns.onmicrosoft.com" } ], "AdminNotifyEmailAddresses": [ { "EmailAddress": "Craig.Robinson@novascotia.ca" }, { "EmailAddress": "Inica.Yang@novascotia.ca" }, { "EmailAddress": "Kevin.Armstrong@novascotia.ca" }, { "EmailAddress": "amy.macdonald@novascotia.ca" } ] }');
	INSERT INTO public."Form_Submission"("Id", "Template_Id", "Data")
